...
<body class="bg-success">
    ...
    <div class="container-fluid">
        ...
        <div class="row intro py-1">
            ...
            <div class="col-sm-12 col-md img text-center">
                <img class="im" src="../PHP/img/bank.png" class="img-fluid pt-2">
            </div>
        </div>
        ...
        <br>
        <br>
        <h3 class="action" style="color: white"><span style="font-family: 'Roboto Slab', serif">CHOOSE AN ACTION</h3></span>
    ...
    <footer class="text-center mt-5 py-2">
        <p id="foot">A Project by <b>Aswini Mohan</b> <br>for The Sparks Foundation </p>
    </footer>
